...
const contactLinks = [
  {
    label: 'Email',
    value: 'eugeuo.vecino@gmail.com',
    href: 'mailto:eugeuo.vecino@gmail.com',
    external: false,
    bg: '#fff1f2',
  ...
  {
    label: 'LinkedIn',
    value: 'linkedin.com/in/eugeuo-vecino',
    href: 'https://linkedin.com/in/eugeuo-vecino',
    external: true,
    bg: '#eef2ff',
  ...
  {
    label: 'GitHub',
    value: 'github.com/eugeuo-vecino',
    href: 'https://github.com/eugeuo-vecino',
    external: true,
    bg: '#f3f4f6',
